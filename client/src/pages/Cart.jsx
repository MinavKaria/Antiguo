...
const CartPage = () => {
  ...
  const [cartItems, setCartItems] = useState([
    {
      id: 1,
      image: "https://s3-alpha-sig.figma.com/img/6dd1/4b95/6a316b2558e25dbe2cc135da7f721a50?Expires=1728864000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=K-nQnFveDPrne~6xAB32EYujidYBmIWxcbRa6U3rGf~9KU4Gz6o3~K4R6EszC421WX1gbYMnsfYDqRYrnU49m0eDVtjnY9pO1a~BGKuQ8KHm5HqOkqUG00m6F2M9eNT5ae0dcWNN2x-MHDzJ9yfxHRhhXVWnMIfNEWGsc1bFS0L2wOqcUSXmiwcCi8qb0KTGci2hO6pg7VRxvFouCLbOLLrtRBiLGB16TAqN50GHGMNvGDB77tdwbKys73vusCkWnctRoUdfr2vGB~XKEKXhGL7aJzfVxp~zuIuv~IrjeQPGgPDPKA~LniDj4YKXF5e23xcy1nihm27bADoNac5wAg__", 
    ...
    {
      id: 3,
      image: "https://s3-alpha-sig.figma.com/img/f306/0bc9/73d24a3025945f88e7fa54dc0aa03a21?Expires=1728864000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=AkxaY7yWUhRB05MlAyENEEMKQLrDqdNGviD9TbIy1vFB37QQJvRBcYzHcO9jjcZQswObdSPLYPSUE5-t8sSe~lWxAMKIdGPLETwYFmV3OY5alwl6PZugEl8mUKegC1rzHCp7as~QzOh-hiflwbypWjjFTuJx2~C0t8VLQzU1GXjiL4WcuGzIqnNsLyc8QGozVHqwqNVxyKJME603GmONcld4O4EW4pbTxwy28f0737rUnYfrrtMk6JrYhAmwfkin4~gDaaDU12Xj-e9JCZpvU5Ac5d5BaSukys-jpXxPeUrNAXvaxizk3TgUjdRYbaaOzZ1VkCzFLHcYt83EjUXYxQ__",
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full table-auto text-left">
          ...
          <tbody>
            {cartItems.map((item) => (
              <tr key={item.id} className="border-b md:table-row flex flex-col md:flex-row space-y-4 md:space-y-0">
                <td className="px-4 py-2 flex md:block">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <span className="block md:hidden">{item.color} / {item.size}</span>
                    </div>
                  </div>
                </td>
